 ...
 * 	@ launchDisplay() 
 * @param type - the type of matrix, e.g. "load_interfile" or "preview"
 */
...
/**
 * Pre-load_interfile pictureBoxes into image objects
 * 
 * @param loadObj -
...
function loadPreviewMatrix(loadObj) {
	...
	if (loadObj.xBins == undefined) {
		alert('Please first load_interfile a dataset!');
		return;
	}
...
function drawImageAtPosition(pos) {
	...
	if (redraw) {
		...
		// color the load_interfile box of previous image back to original color
		if (curPictureBox != null) { 
